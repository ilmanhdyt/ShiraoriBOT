 ...
 */
    ...
    */
     ...
     * @param {Object} options
     */
    async sendButtonLoc(jid, content, footer, button1, row1, quoted, options = {}) {
      return await this.sendMessage(jid, {
        contentText: content,
        footerText: footer,
        buttons: [
    ...
    async send2ButtonLoc(jid, content, footer, button1, row1, button2, row2, quoted, options = {}) {
      return await this.sendMessage(jid, {
        contentText: content,
        footerText: footer,
        buttons: [
    ...
    async send3ButtonLoc(jid, content, footer, button1, row1, button2, row2, button3, row3, options = {}) {
      return await this.sendMessage(jid, {
        contentText: content,
        footerText: footer,
        buttons: [
