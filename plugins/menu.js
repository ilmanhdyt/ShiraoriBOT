...
let handler = async (m, { conn, usedPrefix: _p, args, command }) => {
 ...
 if (teks == 'anime') tags = {
  ...
  try {
    ...
    await conn.sendButtonLoc(m.chat, await (await fetch("https://telegra.ph/file/402516e12a697aba782e1.jpg")).buffer(), text.trim(), 'Ilman\nSHIRAORI BOT MADE BY ILMAN', 'PEMILIK SHIRAORI', '.owner', m)
  } catch (e) {
