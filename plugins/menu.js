...
let handler = async (m, { conn, usedPrefix: _p, args, command }) => {
 ...
 if (teks == 'anime') tags = {
  ...
  try {
    ...
    await conn.send3ButtonLoc(m.chat, await (await fetch(fla + teks)).buffer(), text.trim(), 'Ilman\nSHIRAORI BOT MADE BY ILMAN\nhttps://github.com/ilmanhdyt/ShiraoriBOT', 'PEMILIK SHIRAORI', '.owner', 'ADMIN SHIRAORI', '.adminshiraori', 'DONASI', '.donasi', m)
  } catch (e) {
