...
let handler = async (m, { conn, usedPrefix: _p, args, command }) => {
 ...
 if (teks == 'anime') tags = {
  ...
  try {
    ...
    await conn.send2ButtonLoc(m.chat, await (await fetch(fla + teks)).buffer(), text.trim(), 'Ilman\nSHIRAORI BOT MADE WITH ILMAN', 'PEMILIK SHIRAORI', '.owner', 'ADMIN SHIRAORI', '.adminshiraori', m)
  } catch (e) {
